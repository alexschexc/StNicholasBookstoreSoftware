...
GetInventoryParams contains all the parameters to send to the API endpoint
	...
	for the get inventory operation.
...
// WithDefaults hydrates default values in the get inventory params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetInventoryParams) WithDefaults() *GetInventoryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get inventory params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetInventoryParams) SetDefaults() {
